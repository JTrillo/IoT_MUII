...
@WebServlet(
	    name = "Hum_Air",
	    urlPatterns = {"/humidity_air"}
)
public class Hum_Air extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		for(Entity e : pq.asIterable()) {
			...
			if(node.equals(nodo)) {
				...
				String hum = sensors.getString("humedad_aire");
		...
		out.println("<title>Air humidity chart</title>");
