	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		for(Entity e : pq.asIterable()) {
			...
			if(node.equals(nodo)) {
				...
				String pres = sensors.getString("presion");
		...
		out.println("<title>Atmospheric pressure chart</title>");
		...
		for(Date d : timestamps) {
			...
			out.println("y_axis.push("+pressures.get(cont)+");");
			cont++;
		}
		/*for(int i=0; i<timestamps.size(); i++) {
			out.println("x_axis.push("+timestamps.get(i)+");");
			out.println("y_axis.push("+pressures.get(i)+");");
		}*/
		...
		out.println("var layout = {\r\n" + 
				"  title: 'Atmospheric pressure chart',\r\n" + 
				"  xaxis: {\r\n" + 
				"    title: 'Date',\r\n" + 
				"    titlefont: {\r\n" + 
